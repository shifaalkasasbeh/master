...
<button type="submit" name ="delete" style="background-color: white; border : none;" ><i class='far fa-times-circle' style='font-size:24px ; padding-top : 30px; color:gray;'></i></button>
</form></td>
