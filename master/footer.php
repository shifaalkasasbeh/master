    ...
    <div class="container text-center text-md-start mt-5">
      ...
      <div class="row mt-3">
        ...
        <div class="col-md-3 col-lg-4 col-xl-3 mx-auto mb-4">
          <!-- Content -->
          <h6 class="text-uppercase fw-bold">local store</h6>
          <hr
        ...
        <div class="col-md-4 col-lg-3 col-xl-3 mx-auto mb-md-0 mb-4">
          ...
          <p><i class="fa fa-phone mr-3"></i> +962790746487</p>
          <p><i class="fa fa-print mr-3"></i> +962778688526</p>
        </div>
        <!-- Grid column -->
      </div>
      <!-- Grid row -->
