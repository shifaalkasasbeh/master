    ...
    <div class="sb-top-bar-frame">
      ...
      <div class="sb-minicart">
        <div class="sb-minicart-content">
          ...
          <a href="product.html" class="sb-menu-item sb-menu-item-sm sb-mb-15">
            <div class="sb-cover-frame">
              <img src="img/illustrations/img-12.webp" alt="product">
            </div>
            <div class="sb-card-tp">
            ...
            <div class="col-lg-6">
              <div class="sb-ilustration-fix">
                <div class="sb-illustration-1-2">
                  <img src="{{asset('/publicthem/img/illustrations/img-29.png')}}" alt="food" class="sb-food-1">
                  <img src="{{asset('/publicthem/img/illustrations/img-23.png')}}" alt="food" class="sb-food-2">
                  <img src="{{asset('/publicthem/img/illustrations/img-30.png')}}" alt="food" class="sb-food-3">
          ...
          <div class="swiper-container sb-short-menu-slider-3i">
            <div class="swiper-wrapper">
              <div class="swiper-slide">
                <a data-fancybox="menu" data-no-swup href="{{asset('/publicthem/img/illustrations/img-26.png')}}" class="sb-menu-item">
                  <div class="sb-cover-frame">
                    <img src="{{asset('/publicthem/img/illustrations/img-26.png')}}" alt="product">
                  </div>
                  <div class="sb-card-tp">
              ...
              <div class="swiper-slide">
                <a data-fancybox="menu" data-no-swup href="{{asset('/publicthem/img/illustrations/img-28.png')}}" class="sb-menu-item">
                  <div class="sb-cover-frame">
                    <img src="{{asset('/publicthem/img/illustrations/img-28.png')}}" alt="product">
              ...
              <div class="swiper-slide">
                <a data-fancybox="menu" data-no-swup href="{{asset('/publicthem/img/illustrations/img-27.png')}}" class="sb-menu-item">
                  <div class="sb-cover-frame">
                    <img src="{{asset('/publicthem/img/illustrations/img-27.png')}}" alt="product">
                  </div>
                  <div class="sb-card-tp">
